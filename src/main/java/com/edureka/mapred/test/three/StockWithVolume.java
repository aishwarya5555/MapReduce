...
public class StockWithVolume extends Configured implements Tool {

	public static void main(String[] args) throws Exception {
		int runStatus = ToolRunner.run(new Configuration(), new StockWithVolume(), args);
	...
	public int run(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "StockWithVolume");
		job.setJobName("StockWithVolume");
		job.setJarByClass(getClass());
		job.setMapOutputKeyClass(Text.class);
		job.setMapOutputValueClass(LongWritable.class);
		job.setOutputKeyClass(Text.class);
		job.setOutputValueClass(LongWritable.class);
		job.setMapperClass(StockWithVolumeMapper.class);
		job.setReducerClass(StockWithVolumeReducer.class);
